...
export const StyledLabel = styled.label < any > `
  ...
  & ${CheckMark} {
    ...
    top: 0;
    left: 0;
    ${({ size, configuration }) => getCheckSizes(size, configuration.controlHeight).circle}
  ...
  & ${CheckMark}:after {
    ${({ size, configuration }) => getCheckSizes(size, configuration.controlHeight).circle_after};
    ${({ size, configuration }) => getCheckSizes(size, configuration.controlHeight).circle_after_size};
    border: solid white;
